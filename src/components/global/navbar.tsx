  ...
  return (
    ...
    z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between">
        <aside className="flex items-center gap-[2px]">
            <p className="text-2xl font-bold">Cha</p>
            <Image
                src="/fuzzieLogo.png"
                width={15}
                height={15}
        ...
        <nav className='abusolute left-[50%] top-[50%] transform translate-x-[-50%] hidden md:block'>
        ...
        <Link
          ...
          rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 
